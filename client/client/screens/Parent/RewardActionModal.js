...
const RewardActionModal = ({ Reward, isVisible, onClose, onUpdate, onDelete }) => {
    if (!Reward) {
    ...
    <Modal
      ...
      <View style={styles.modalView}>
        ...
        <View style={styles.modalButtons}>
          ...
          <Button title="Update" onPress={() => onUpdate(Reward.id)} />
          <Button title="Delete" onPress={() => onDelete(Reward.id)} />
        </View>
